...
import {ValidReviewer} from "../contracts/ValidReviewer.sol";
...
contract ValidReviewerDeploy is Script {
    function run() external {
        ...
        ValidReviewer reviewer = new ValidReviewer(verifier);
        console2.log("Deployed ValidReviewer to", address(reviewer));
